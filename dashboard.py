...
st.markdown('<style>div.block-container{padding-top}',unsafe_allow_html=True)
...
if fl is not None :
    ...
    os.chdir(r"C:\\Users\\Zakariae\\Desktop\\MyProjects\\Data\\StreamlitProject")
...
if not region and not state and not city :
    ...
    filtered_df = df3[df["Region"].isin(state) & df["City"].isin(city) ]
...
#Create a tr based on Region , category , sub category
